...
#[non_exhaustive]
pub enum GoogleOnboardingStateType {
    ...
    ProvisionedProject,
    #[serde(rename(
        serialize = "provisionedRefreshToken",
        deserialize = "ProvisionedRefreshToken"
    ))]
    ProvisionedRefreshToken,
    #[serde(rename(
        serialize = "provisionedRefreshTokenError",
        deserialize = "ProvisionedRefreshTokenError"
    ))]
    ProvisionedRefreshTokenError,
    #[serde(rename(
        serialize = "provisionedServiceAccount",
        deserialize = "ProvisionedServiceAccount"
    ))]
    ProvisionedServiceAccount,
    #[serde(rename(
        serialize = "provisionedServiceAccountKey",
        deserialize = "ProvisionedServiceKeyAccount"
    ))]
    ProvisionedServiceAccountKey,
    #[serde(rename(
        serialize = "provisionedServiceAccountKeyError",
        deserialize = "ProvisionedServiceAccountKeyError"
    ))]
    ProvisionedServiceAccountKeyError,
    #[serde(rename(serialize = "provisionApisError", deserialize = "ProvisionApisError"))]
    ProvisionApisError,
    #[serde(rename(
        serialize = "provisionProjectError",
        deserialize = "ProvisionProjectError"
    ))]
    ProvisionProjectError,
    #[serde(rename(
        serialize = "provisionServiceAccountError",
        deserialize = "ProvisionServiceAccountError"
    ))]
...
pub struct GoogleOnboardingModel {
    pub consent_url: Option<String>,
    pub domain_wide_delegation: Option<String>,
    pub config: GoogleOnboardingConfigModel,
    pub id: String,
    pub created: String,
    pub connection_id: Option<String>,
    pub error: Option<String>,
    pub state: GoogleOnboardingStateType,
}
